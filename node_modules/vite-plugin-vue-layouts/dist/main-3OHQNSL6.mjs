...
function withFormatting(text, edit, options) {
  ...
  const edits = format(newText, { offset: begin, length: end - begin }, __spreadProps(__spreadValues({}, options.formattingOptions), { keepLines: false }));
